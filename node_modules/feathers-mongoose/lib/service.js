...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    value: function create(data, params) {
      ...
      return this.Model.create(data).then(function (result) {
        return _this.lean && result.toObject ? result.toObject() : result;
    ...
    value: function patch(id, data, params) {
      ...
      try {
        return ids.then(function (idList) {
          ...
          return _this2.Model.update((0, _lodash2.default)(query, '$populate'), data, options).lean(_this2.lean).exec().then(function () {
    ...
    value: function remove(id, params) {
      ...
      return this._getOrFind(id, params).then(function (data) {
        return _this3.Model.remove(query).lean(_this3.lean).exec().then(function () {
          return data;
        }).then((0, _feathersCommons.select)(params, _this3.id));
      }).catch(_errorHandler2.default);
    }
  }]);
